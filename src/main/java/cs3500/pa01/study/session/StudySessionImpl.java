package cs3500.pa01.study.session;

import cs3500.pa01.gen.FileWriter;
import cs3500.pa01.study.question.Question;
import cs3500.pa01.study.question.QuestionsDataHandler;
import cs3500.pa01.study.user.StudyUser;
import cs3500.pa01.study.user.User;
...
public class StudySessionImpl implements StudySession {
  ...
  private void startSessionMessage() {
    String start = "\nNow, let's begin your study session!\n"
        ...
        + "When you want to exit, say exit or -1.\n";
