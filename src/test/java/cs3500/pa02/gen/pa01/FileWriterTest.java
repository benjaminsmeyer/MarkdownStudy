...
class FileWriterTest {
   ...
   */
  @Test
  void testWriteToFileWithFileNameSort() throws IOException {
   ...
   */
  @Test
  void testSortMarkdownFileName() throws IOException {
   ...
   */
  @Test
  void testSortMarkdownCreated() throws IOException {
   ...
   */
  @Test
  void testSortMarkdownLastModified() throws IOException {
    assertEquals((vectorExpectedOutput + "\n" + arrayExpectedOutput).trim(),
